...
## Priority: HIGH
## Status: COMPLETE
## Estimated Scope: 24 files (all documented)
...
- [x] Document gen_dir.py directory structure
- [x] Document gen_hl.py signal generation
- [x] Document gen_alpha.py alpha file format

### 5. Utility Documentation
- [x] Document util.py module and all functions
- [x] Document each utility script purpose (10 scripts: hl.py, hl_csv.py, change_hl.py, check_hl.py, check_all.py, change_raw.py, mktcalendar.py, get_borrow.py, show_borrow.py, show_raw.py)
- [x] Document CLI usage for each utility script

### 6. Relationship Documentation
- [x] Document differences from main codebase (see salamander/README.md)
- [x] Document when to use salamander vs main (see salamander/README.md)
- [x] Document data compatibility (see salamander/README.md and individual file docstrings)
